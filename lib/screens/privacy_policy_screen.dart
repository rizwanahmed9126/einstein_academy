...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  @override
  void initState() {
    Provider.of<TeacherProvider>(context,listen: false).privacyPolicy=null;

    Provider.of<TeacherProvider>(context,listen: false).callPrivacyPolicy().then((value){
      if(value=="noData"){
        setState(() {
          noData=true;
        });
