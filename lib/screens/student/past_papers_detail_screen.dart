...
class PastPapersDetailsScreen extends StatefulWidget {
  final String id;
  const PastPapersDetailsScreen({Key? key,required this.id}) : super(key: key);

  @override
  _PastPapersDetailsScreenState createState() =>
      _PastPapersDetailsScreenState();
}

class _PastPapersDetailsScreenState extends State<PastPapersDetailsScreen> {
  ...
  getData()async{
    Provider.of<StudentProvider>(context,listen: false).pastPapersDetailData=null;
    await Provider.of<StudentProvider>(context,listen: false).callPastPapersDetail(widget.id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<StudentProvider>(
        builder: (context,i,_){
          return i.pastPapersDetailData!=null? SingleChildScrollView(
            child: Container(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${i.pastPapersDetailData!.subject.name}",
                                style: TextStyle(
                                    fontSize: 9.sp,
                              ...
                              Text(
                                "${i.pastPapersDetailData!.grade.name}",
                                style: TextStyle(
                                    fontSize: 9.sp,
                                    fontWeight: FontWeight.w500,
                                    color: Colors.grey.shade800),
                          ...
                          ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: i.pastPapersDetailData!.medias.length,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          child: Image(
                                            image: AssetImage(
                                                //i.studentNotesDetail!.type =="pdf"?
                                                "assets/images/pdf.png"
                                                // //:i.studentNotesDetail!.type=="Video"? "assets/images/mp4.png"
                                                //     :i.studentNotesDetail!.type=="docx"? "assets/images/doc.png"
                                                //     :i.studentNotesDetail!.type=="pptx"? "assets/images/pptx.png"
                                        ...
                                        Container(
                                            ...
                                            child: Text( i.pastPapersDetailData!.medias[index].name,
                                              //i.pastPapersDetailData!.medias[index].path.split('/').last ,
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () async{
                                                ...
                                                //if (i.pastPapersDetailData!.type=="pdf"){
                                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFWidget(url: i.pastPapersDetailData!.medias[index].path,)));


                                                // }
                                                // else{
                                                //   //downloadFile( i.studentNotesDetail!.medias[index].path,);
                                                //
                                                // }
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                   // i.pastPapersDetailData!.type=="pdf"?
                                                    "View",
                                                    // // :i.studentNotesDetail!.type=="Audio" || i.studentNotesDetail!.type=="Video"?"Play"
                                                    //     :"Download",
                                                    style: TextStyle(
                                                        fontSize: 8.sp,
                                                        color: Color.fromRGBO(
                          ...
                          Center(
                            child: Column(
                              children: [
                                ...
                                //   child: FadeInImage(
                                //
                                //     image: NetworkImage("${i.studentNotesDetail!.user.profileImg}",),
                                ...
                                // ),
                                // RatingBar.builder(
                                //   initialRating: double.parse(i.studentNotesDetail!.rating.toString()),
                                //   minRating: 0,
                                ...
                                // InkWell(
                                //   onTap: (){
                                //     Provider.of<AuthProvider>(context,listen: false).callFollowUnFollow(i.studentNotesDetail!.user.id.toString()).then((value){
                                //       setState(() {
                                //         i.studentNotesDetail!.isFollow=!i.studentNotesDetail!.isFollow;
                                //       });
                                ...
                                //     decoration: BoxDecoration(
                                //       borderRadius: BorderRadius.circular(3.r),
                                //       color:i.studentNotesDetail!.isFollow?
                                ...
                                //       child: Row(
                                //         children: [
                                //           i.studentNotesDetail!.isFollow?  Icon(
                                //             Icons.check,
                                //             color: Colors.white,
                                //             size: 10.h,
                                //           ):Container(),
                                //           i.studentNotesDetail!.isFollow? SizedBox(
                                //             width: 5.w,
                                //           ):Container(),
                                //
                                //
                                ...
                                //             style: TextStyle(
                                //                 fontSize: 8.sp,
                                //                 color:i.studentNotesDetail!.isFollow?Colors.white:Color.fromRGBO(30, 144, 241, 1,),
                                //                 fontWeight: FontWeight.w600),
                                //           ),
                                //         ],
                                //       ),
                                ...
                                InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ReportIssueScreen(id: i.studentNotesDetail!.id.toString(),type: "study-notes",)));
                                  },
                                  child: Container(
                                    height: 30,
                                    width: width*0.5,
